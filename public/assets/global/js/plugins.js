        ...
        setTimeout(function () {
            $('select').each(function(){
                ...
                $(this).select2({
					...
					// if $('#team_leader').each(function(){
                    // maximumSelectionSize: 3 // Limit the number max of selection for multiple select
					// }
                });
				$('#team_leader').select2({
                    
                    maximumSelectionSize: 30 // Limit the number max of selection for multiple select
           ...
           if ($(this).hasClass('filter-between_date')) {
            ...
            if ($(this).hasClass('filter-select')) {
                $(this).DataTable( {
             	...
             	/*Set Top*/
             	$('.filter-select tfoot tr').insertBefore($('.filter-select thead tr'));
            ...
            if (!$(this).hasClass('filter-between_date') &&!$(this).hasClass('filter-head') && !$(this).hasClass('filter-footer') && !$(this).hasClass('filter-select'))  {
