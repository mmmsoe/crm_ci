...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    	<center><br>
        	<h1>
            	<a href="http://spruce.jo" target="_blank">
                	Spruce Sales & CRM
                </a>
            </h1>
					...
					<form action="<?php echo base_url('install/do_install'); ?>" id="formElem" name="formElem" method="post" accept-charset="utf-8">
                        ...
                        <fieldset class="step">
                            ...
                            <p>
                            	...
                            	<a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">Learn more</a>
                            </p>
                        </fieldset>                       
                        <fieldset class="step">
