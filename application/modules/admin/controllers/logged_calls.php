...
class Logged_calls extends CI_Controller {
    ...
    function Logged_calls() {
        ...
        $this->load->model("opportunities_model", "om");
    ...
    function view($call_id) {
        ...
        $this->load->view('header');
        $this->load->view('logged_calls/view', $data);
        $this->load->view('footer');
    }
    ...
    function get_opportunities_by_comp()
    {
        $company_id = $this->input->post('company_id');
        echo json_encode(array('data'=>$this->om->get_sel_opportunities_by_company($company_id)));
    }
    
    function get_contacts_by_comp()
    {
        $company_id = $this->input->post('company_id');
        $data = $this->om->get_sel_contacts_by_company($company_id);
