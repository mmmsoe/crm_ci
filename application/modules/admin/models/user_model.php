...
class User_model extends CI_Model {
    ...
    function get_role($id) {
        $role_id = $this->db->get_where('users', array('id' => $id))->result();
        return $role_id;
    }
    ...
    function get_app_ver() {
        //create by uye 20 june 2016

        return $this->db->get('app_ver')->row();
    }
    ...
    function change_profile() {
        ...
        if (empty($_FILES['avatar']['name'])) {
            ...
            delete_files(base_url("uploads/staffs/" . $user->user_avatar));
    ...
    {
        $q = "select smtp_user, smtp_pass, smtp_host, smtp_port, imap_host, imap_port from users WHERE id = '".$this->session->userdata('id')."'";
