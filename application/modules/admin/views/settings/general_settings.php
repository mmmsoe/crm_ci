...
<script>
    ...
    function upload_settings()
    {
        ...
        $.ajax({
            ...
            beforeSend: function (msg) {
                $("#upload_submitbutton").html('<img src="<?php echo base_url('public/images/loading.gif'); ?>" />');
            },
            success: function (msg)
            {
                $('body,html').animate({scrollTop: 0}, 200);
    ...
    function sales_tax_settings()
    {
        ...
        $.ajax({
            ...
            beforeSend: function (msg) {
                $("#sales_tax_submitbutton").html('<img src="<?php echo base_url('public/images/loading.gif'); ?>" />');
            },
            success: function (msg)
            {
                $('body,html').animate({scrollTop: 0}, 200);
	...
	function qoutation_exp_settings()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/settings/qoutation_exp_settings'); ?>",
            data: $("#qoutation_exp_settings").serialize(),
            beforeSend: function (msg) {
                $("#qoutation_exp_submitbutton").html('<img src="<?php echo base_url('public/images/loading.gif'); ?>" />');
            },
            success: function (msg)
            {
                $('body,html').animate({scrollTop: 0}, 200);
                $("#qoutation_exp_ajax").html(msg);
                $("#qoutation_exp_submitbutton").html('<button type="submit" class="btn btn-embossed btn-primary" onclick="sales_tax_settings()">Save</button>');

                $("qoutation_exp_settings")[0].reset();
            }
        });
    }
    ...
    function invoice_prefix_settings()
    {
        ...
        $.ajax({
            ...
            beforeSend: function (msg) {
                $("#invoice_prefix_submitbutton").html('<img src="<?php echo base_url('public/images/loading.gif'); ?>" />');
            },
            success: function (msg)
            {
                $('body,html').animate({scrollTop: 0}, 200);
    ...
    function payment_term_settings()
    {
        ...
        $.ajax({
            ...
            beforeSend: function (msg) {
                $("#payment_term_submitbutton").html('<img src="<?php echo base_url('public/images/loading.gif'); ?>" />');
            },
            success: function (msg)
            {
                $('body,html').animate({scrollTop: 0}, 200);
    ...
    function smtp_settings()
    {
        ...
        $.ajax({
            ...
            beforeSend: function (msg) {
                $("#smtp_submitbutton").html('<img src="<?php echo base_url('public/images/loading.gif'); ?>" />');
            },
            success: function (msg)
            {
                $('body,html').animate({scrollTop: 0}, 200);
    ...
    function reminder_settings()
    {
        ...
        $.ajax({
            ...
            beforeSend: function (msg) {
                $("#reminder_submitbutton").html('<img src="<?php echo base_url('public/images/loading.gif'); ?>" />');
            },
            success: function (msg)
            {
                $('body,html').animate({scrollTop: 0}, 200);
    ...
    function title_tags_prio_settings()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/settings/title_tags_prio_settings'); ?>",
            data: $("#title_tags_prio_settings").serialize(),
            beforeSend: function (msg) {
                $("#title_tags_submitbutton").html('<img src="<?php echo base_url('public/images/loading.gif'); ?>" />');
            },
            success: function (msg)
            {
                $('body,html').animate({scrollTop: 0}, 200);
                $("#title_tags_ajax").html(msg);
                $("#title_tags_submitbutton").html('<button type="submit" class="btn btn-embossed btn-primary" onclick="title_tags_prio_settings()">Save</button>');
...
<div class="page-content page-thin">
    <!--div>
                    <a href="<?php echo base_url('admin/settings/'); ?>" class="btn btn-black btn-embossed"> Settings</a> 	
      </div-->
    <div class="row">
        <div class="col-md-12">
            <div class="panel">                    
                <div class="panel-content">
                    ...
                    <div class="tab-content">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <select class="form-control" data-style="white" name="max_upload_files">
                                                                <option value="1" <?php
                                                                if (config('max_upload_files') == 1) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>1</option>
                                                                <option value="2" <?php
                                                                if (config('max_upload_files') == 2) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>2</option>
                                                                <option value="3" <?php
                                                                if (config('max_upload_files') == 3) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>3</option>
                                                                <option value="4" <?php
                                                                if (config('max_upload_files') == 4) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>4</option>
                                                                <option value="5" <?php
                                                                if (config('max_upload_files') == 5) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>5</option>
                                                                <option value="6" <?php
                                                                if (config('max_upload_files') == 6) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>6</option>
                                                                <option value="7" <?php
                                                                if (config('max_upload_files') == 7) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>7</option>
                                                                <option value="8" <?php
                                                                if (config('max_upload_files') == 8) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>8</option>
                                                                <option value="9" <?php
                                                                if (config('max_upload_files') == 9) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>9</option>
                                                                <option value="10" <?php
                                                                if (config('max_upload_files') == 10) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>10</option>
                                                            </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <select class="form-control" data-style="white" name="max_upload_file_size">
                                                                ...
                                                                if (config('max_upload_file_size') == 1000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>1 MB</option>
                                                                <option value="2000" <?php
                                                                if (config('max_upload_file_size') == 2000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>2 MB</option>
                                                                <option value="3000" <?php
                                                                if (config('max_upload_file_size') == 3000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>3 MB</option>
                                                                <option value="4000" <?php
                                                                if (config('max_upload_file_size') == 4000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>4 MB</option>
                                                                <option value="5000" <?php
                                                                if (config('max_upload_file_size') == 5000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>5 MB</option>
                                                                <option value="6000" <?php
                                                                if (config('max_upload_file_size') == 6000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>6 MB</option>
                                                                <option value="7000" <?php
                                                                if (config('max_upload_file_size') == 7000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>7 MB</option>
                                                                <option value="8000" <?php
                                                                if (config('max_upload_file_size') == 8000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>8 MB</option>
                                                                <option value="9000" <?php
                                                                if (config('max_upload_file_size') == 9000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>9 MB</option>
                                                                <option value="10000" <?php
                                                                if (config('max_upload_file_size') == 10000) {
                                                                    echo 'selected="selected"';
                                                                }
                                                                ?>>10 MB</option>
                                                            </select>
								...
								<div class="col-sm-6">
									<div>
										...
										<form id="sales_tax_settings" class="form-validation" novalidate="novalidate">
											...
											<div id="sales_tax_submitbutton" class="col-sm-4" style="padding-top: 25px;">
												<button type="submit" class="btn btn-embossed btn-primary" onclick="sales_tax_settings()">Save</button>
											</div>
											</div>
										</form>
									</div>
									...
									<div>
										...
										<form id="invoice_prefix_settings" class="form-validation" novalidate="novalidate">
											...
											<div id="invoice_prefix_submitbutton" class="col-sm-4" style="padding-top: 25px;">
												<button type="submit" class="btn btn-embossed btn-primary" onclick="invoice_prefix_settings()">Save</button>
											</div>
											</div>
										</form>
									</div>
									<div>
										<div id="qoutation_exp_ajax">                      	                       
											<?php
											if ($this->session->flashdata('message')) {
												echo $this->session->flashdata('message');
											}
										...
										<form id="qoutation_exp_settings" class="form-validation" novalidate="novalidate">
											<div class="row">
											<div class="form-group col-sm-8">
												<label class="control-label">Quotation Expired</label>
												<div class="append-icon">
													<input type="text" name="qoutation_exp" value="<?php echo config('quotation_exp'); ?>" class="form-control">
												</div>
											</div>
											<div id="qoutation_exp_submitbutton" class="col-sm-4" style="padding-top: 25px;">
												<button type="submit" class="btn btn-embossed btn-primary" onclick="qoutation_exp_settings()">Save</button>
											</div>
											</div>
										</form>
									</div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <input type="text" name="smtp_port" value="<?php echo $setting_list->smtp_port; ?>" class="form-control">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label">IMAP Host</label>
                                                        <div class="append-icon">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <input type="text" name="imap_port" value="<?php echo $setting_list->imap_port; ?>" class="form-control">
                        ...
                        <div class="tab-pane fade in" id="tab1_9">
                            <div class="panel-body bg-white">
                                <div class="col-md-8" align="center">

                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div id="title_tags_ajax">                      	                       
                                            <?php
                                            if ($this->session->flashdata('message')) {
                                                echo $this->session->flashdata('message');
                                            }
                                        ...
                                        <form id="title_tags_prio_settings" class="form-validation" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Titles &nbsp;<i class="icon-info" rel="popover" data-container="body" data-toggle="popover" data-placement="top" data-content="For Example: Sir,Madam,Miss,Mister" data-original-title="Set Titles"></i></label>
                                                        <div>
                                                            <input name="titles" value="<?php echo config('titles'); ?>" class="select-tags form-control">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Functions &nbsp;<i class="icon-info" rel="popover" data-container="body" data-toggle="popover" data-placement="top" data-content="For Example: Sales manager, Manager" data-original-title="Set Functions"></i></label>
                                                        <div>
                                                            <input name="functions" value="<?php echo config('functions'); ?>" class="select-tags form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Tags &nbsp;<i class="icon-info" rel="popover" data-container="body" data-toggle="popover" data-placement="top" data-content="For Example: Product,Software" data-original-title="Set Tags"></i></label>
                                                        <div>
                                                            <input name="tags" value="<?php echo config('tags'); ?>" class="select-tags form-control">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Priorities &nbsp;<i class="icon-info" rel="popover" data-container="body" data-toggle="popover" data-placement="top" data-content="For Example: Low,High" data-original-title="Set Priorities"></i></label>
                                                        <div>
                                                            <input name="priorities" value="<?php echo config('priorities'); ?>" class="select-tags form-control">
                                            ...
                                            <div class="text-left  m-t-20">
                                                <div id="title_tags_submitbutton"><button type="submit" class="btn btn-embossed btn-primary" onclick="title_tags_prio_settings()">Save</button></div>
