...
<div class="page-content">
      	  ...
      	  <div class="header">
            <h2><strong>Logged Call</strong></h2>  
             
            <div class="breadcrumb-wrapper">
                 <a style="float:right;" href="<?php echo base_url()?>admin/logged_calls/update/<?php echo $this->uri->segment(4)?>/<?php echo $this->uri->segment(5)?>" class="btn btn-primary btn-embossed"> Edit</a> 
            </div>  
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="datetimepicker form-control" name="date" id="date" placeholder="" value="<?php echo date('m/d/Y H:i',$call->date); ?>" disabled="disabled">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="field-2" class="control-label">Call	Summary</label>
                        <input type="text" class="form-control" name="call_summary" id="call_summary" value="<?php echo $call->call_summary;?>" placeholder="" disabled="disabled">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="field-4" class="control-label">Contact</label>
                         ...
                         <select name="company_id" id="company_id" class="form-control" data-search="true" disabled="disabled">
					                                <option value=""></option>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="field-5" class="control-label">Responsible</label>
                         <select name="resp_staff_id" id="resp_staff_id" class="form-control" data-search="true"  disabled="disabled">
