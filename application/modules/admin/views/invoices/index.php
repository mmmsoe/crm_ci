 ...
 function delete_invoice( invoice_id )
 {
    ...
    $.ajax({
        ...
        <div class="page-content">
        	<div class="row">
            <div>
                <a  style="float:right;" href="<?php echo base_url('admin/invoices/receive_payments_number/'); ?>" class="btn btn-primary" style="float:right; color:white; background-color:#0C59B0;">RECEIVE PAYMENT</a>
                <a href="<?php echo base_url('admin/invoices/'); ?>" class="btn btn-black btn-embossed"> Manage Invoices</a> 	
		    </div>
