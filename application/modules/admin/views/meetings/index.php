...
<!--h2 class="col-md-6"><strong>Meetings</strong></h2--> 
        <div>
            ...
            <?php if (check_staff_permission('meetings_write')) { ?> <a style="float:right;" href="<?php echo base_url('admin/meetings/add/'); ?>" class="btn btn-primary btn-embossed"> Create New</a> <?php } ?>
            <?php if (check_staff_permission('meetings_read')) { ?> <a href="<?php echo base_url('admin/meetings'); ?>" class="btn btn-black btn-embossed"> Meetings</a><?php } ?>
