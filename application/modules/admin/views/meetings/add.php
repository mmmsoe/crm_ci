...
<?php if ($this->uri->segment(4) != ""): ?>
            getcontactdetails(<?php echo $this->uri->segment(4); ?>);
                ...
                <form id="add_meeting" name="add_meeting" class="form-validation" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
							<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="company_id" id="company_id" class="form-control" data-search="true" onchange="getcontactdetails(this.value); get_opportunities(this.value)">
                                        <option></option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="field-4" class="control-label" style="color:red;">* Opportunity</label>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="append-icon">
                                                    ...
                                                    <textarea name="meeting_description" rows="1" class="form-control" placeholder="describe the product characteristics..."></textarea>   
                                                </div>
                                            </div>
                                        </div>
                                    </div>
