...
<div class="page-content">
    ...
    <a style="float:right;" href="<?php echo base_url()?>admin/meetings/edit_meeting/<?php echo $this->uri->segment(4)?>/<?php echo $this->uri->segment(5)?>" class="btn btn-primary btn-embossed"> Edit</a> 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="meeting_subject" id="meeting_subject" value="<?php echo $meeting->meeting_subject; ?>" placeholder="" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="field-2" class="control-label">Company Name</label>
                                    <select name="company_id" id="company_id" class="form-control" data-search="true" onchange="getcontactdetails(this.value)" disabled="disabled">
                                        <option value=""></option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="attendees[]" id="attendees" class="form-control" data-search="true" disabled="disabled" multiple>
                                        <option value=""></option>
                                        <?php
...
<?php } ?> 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="responsible" id="responsible" class="form-control" data-search="true" disabled="disabled">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="opportunity_id" id="opportunity_id" class="form-control" data-search="true" disabled="disabled">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="starting_date" id="starting_date" class="datetimepicker form-control" placeholder="Choose a date..."  value="<?php echo date('m/d/Y H:i', $meeting->starting_date); ?>"  disabled="disabled">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="append-icon">
                                                    <input type="text" name="location" value="<?php echo $meeting->location; ?>"  class="form-control"  disabled="disabled"/> 
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="append-icon">
                                                    <input type="text" name="ending_date" id="ending_date" class="datetimepicker form-control" placeholder="Choose a date..." value="<?php echo date('m/d/Y H:i', $meeting->ending_date); ?>" disabled="disabled">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="append-icon">
                                                    <input type="checkbox" name="all_day" id="all_day" value="1" <?php if ($meeting->all_day == 1) { ?>checked<?php } ?> data-checkbox="icheckbox_square-blue" disabled="disabled"/> 
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="append-icon">
                                                    ...
                                                    <textarea name="meeting_description" rows="5" class="form-control" placeholder="describe the product characteristics..."  disabled="disabled"><?php echo $meeting->meeting_description; ?></textarea>   
                                                </div>
                                            </div>
                                        </div>
                                    </div>
