        ...
        $.ajax({
            ...
            success: function (msg) {
				...
				if(status=="yes")
				{
					...
					$("#product_ajax").html('<?php echo '<div class="alert alert-success">'.$this->lang->line('create_succesful').'</div>'?>');
					setTimeout(function () {
					                            ...
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
													...
													<?php if ($cat->system_value_txt !=''){ ?>
														<option value="<?php echo $cat->system_code;?>" ><?php echo $cat->system_value_txt;?></option>
													<?php }?> 
													<?php }?> 
					                                </select>
										  ...
										  <div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="quantity_on_hand" value="" class="form-control numeric">
					                          ...
					                          <div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="quantity_available" value="" class="form-control numeric">
										  ...
										  <div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="tax" value="" class="form-control numeric">
					                                <i class="icon-">%</i>
					                              </div>
					                            </div>
											</div>
							                           ...
							                           <div class="panel-body bg-white">
							                            ...
							                            <div class="form-group">
							                              ...
							                              <div class="append-icon">
															...
															echo form_dropdown('product_type', $options,'Consumable','class="form-control"');?>	
							                              </div>
							                            </div>
					                          			</div>
	                          							 <div class="col-sm-6">
							                            <div class="form-group">
	 													 ...
	 													 <div class="row">
									                           ...
									                           <div class="form-group">
									                              ...
									                              <div class="append-icon">
									                                <input type="text" name="sale_price" value="" class="form-control numeric">
												...
												<div class="panel-body bg-white">	
                									 ...
                									 <table class="table">
									                    ...
									                    <tbody id="InputsWrapper">
									                      <!--<tr> 
									                        <td><input type="text" name="attribute_name" value="" class="form-control"></td>
									                        <td><input type="text" name="product_attribute_value" value="" class="form-control"></td>
