        ...
        $.ajax({
            ...
            success: function (msg) {
				...
				if(status=="yes")
				{
					...
					$("#product_ajax").html('<?php echo '<div class="alert alert-success">'.$this->lang->line('update_succesful').'</div>'?>');
					setTimeout(function () {
					window.location.href="<?php echo base_url('admin/products/view' ); ?>/"+id;
                  ...
                  <div class="panel">
                        				...
                        				<div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              <label class="control-label"style="color:red;">* Product Name</label>
	             	...
	             	<?php }?>
					                     ...
					                     <div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              <label class="control-label">Internal Category</label>
					                              <div class="append-icon">
					                                 
					                                 <select name="internal_category" class="form-control" data-search="true">
					                                <option value=""></option>
					                                <?php foreach($categories as $cat){ ?>
													<?php if ($cat->system_value_txt !=''){ ?>
														<option value="<?php echo $cat->system_code;?>" <?php if($product->internal_category==$cat->system_code){?>selected<?php }?>><?php echo $cat->system_value_txt;?></option>
													<?php }?> 
													<?php }?> 
					                                </select>
										  ...
										  <div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="quantity_on_hand" value="<?php echo $product->quantity_on_hand;?>" class="form-control numeric">
					                          ...
					                          <div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="quantity_available" value="<?php echo $product->quantity_available;?>" class="form-control numeric">
										  ...
										  <div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              <label class="control-label" style="color:red">* Taxes</label>
					                              <div class="append-icon">
					                                <input type="text" name="tax" value="<?php echo $product->tax;?>" class="form-control numeric">
					                                <i class="icon-">%</i>
					                              </div>
					                            </div>
											</div>
											<div class="col-sm-6">
												...
												<div class="form-group">
													<select name="uom_id" id="uom_id" class="form-control full" data-search="true">
													<option value="" selected="selected">Choose UOM</option>
													<?php foreach($uoms as $uom){ ?>
													<?php if($uom->system_code !== "00"){ ?>
														<option value="<?php echo $uom->system_code;?>" <?php if($product->uom_id==$uom->system_code){?> selected="selected"<?php }?>><?php echo $uom->system_value_txt;?></option>
													<?php }?> 
													<?php }?> 
													</select>
												</div>
							                            ...
							                            <div class="form-group">
	 													 ...
	 													 <div class="row">
									                           ...
									                           <div class="form-group">
									                              ...
									                              <div class="append-icon">
									                                <input type="text" name="sale_price" value="<?php echo $product->sale_price;?>" class="form-control numeric">
												...
												<div class="panel-body bg-white">	
                									 ...
                									 <table class="table">
									                    ...
									                    <tbody id="InputsWrapper">
									                      ...
									                      <input type="text" name="attribute_name[]" value="<?php echo $variant->attribute_name;?>" class="form-control"></td><td><input type="text" name="product_attribute_value[]" value="<?php echo $variant->product_attribute_value;?>" class="form-control"></td><td><a href="javascript:void(0)" class="delete btn btn-sm btn-danger" onclick="delete_variant(<?php echo $variant->id; ?>)"><i class="icons-office-52"></i></a></td></tr>
									                      <?php } ?>
					 									<?php } ?>
