    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        events: [
	        ...
	        <?php if( ! empty($pricelist_versions) ){?>
		        ...
		        {
		            title: "<?php echo $pricelist_version->pricelist_version_name; ?> - Pricelist Version",
	        ...
	        <?php if( ! empty($quotations) ){?>
		        ...
		        {
		            title: "<?php echo $this->customers_model->get_company($quotation->customer_id)->name; ?> - Quotation Due ",
			...
			<?php if( ! empty($leads) ){?>
		        ...
		        {
		            title: "<?php echo $lead->lead_name; ?> - Lead ",
		            start: new Date(<?php echo $lead->register_time*1000; ?>),
		            className: 'bg-green',
		            //editable : false,
		            allDay: true, 
		            event_url : '<?php echo base_url('admin/leads/view/'.$lead->id); ?>',
	        ...
	        <?php if( ! empty($upcoming_meetings) ){?>
		        ...
		        {
		            title: "<?php echo $this->customers_model->get_company($meetings->company_id)->name; ?> - Meeting ",
	        ...
	        <?php if( ! empty($overdue_invoices) ){?>
		        ...
		        {
		            title: "<?php echo $this->customers_model->get_company($invoices->customer_id)->name; ?> - Invoices ",
	        ...
	        <?php if( ! empty($contracts) ){?>
		        ...
		        {
		            title: "<?php echo $contract->description; ?> - Contract  ",
	        ...
	        <?php if( ! empty($opportunities) ){?>
		        ...
		        {
		            title: "<?php echo $opportunity->opportunity; ?> - Opportunity  ",
