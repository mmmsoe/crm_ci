...
<script>
    function getContactList(id)
    {
        ...
        $('#main_contact_person').empty();
        $('#main_contact_person').append('<option value=""></option>');
        $.ajax({
            type: "POST",
            url: '<?php echo base_url('admin/customers/getContactList') . '/'; ?>',
            data: {customer_id: '<?php echo $customer->id ?>'},
            dataType: 'json',
            success: function (data) {
                $.each(data, function (key, val) {
                    $('#main_contact_person').append('<option value="' + val.id + '">' + val.name + '</option>');
                });
                if (id != "")
                {
                    $('#main_contact_person').select2('val', id);
                }
    ...
    function addcontact()
    {
        //$('#modal-create_contact_person').modal('show');

        $('#modal-confirm').modal('hide');

        $('#modal-confirm').on("hidden.bs.modal", function (e) {
            if ($('#modal-confirm:visible').length == 0)
            {
                $('#modal-create_contact_person').modal('show');
            }
        });
...
<script type="text/javascript">
    ...
    function getWhois()
    {
        $.ajax({
            ...
            dataType: "json",
            success: function (data) {
                $('#name').tokenfield('createToken', data.reg_org);
                //$('#name').val(data.reg_org);
...
<div class="page-content">
    <div class="row">
        ...
        <div style="float:right; padding-top:10px;">
            ...
            <button class="btn btn-primary" data-toggle="modal" data-target="#modal-create_contact_person">New Contact Person</button>
            ...
            <div class="panel-content">
                ...
                <form id="add_customer" name="add_customer" class="form-validation" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">				                         
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="append-icon">
                                    <input type="text" id="website" name="website" value="<?php echo $co_person_id; ?>" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="append-icon">
                                    <input type="text" id="phone" name="phone" value="" class="form-control numeric">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="append-icon">
                                    <input type="text" id="mobile" name="mobile" value="" class="form-control numeric">
                                    <i class="icon-screen-smartphone"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="append-icon">
                                    <input type="text" id="fax" name="fax" value="" class="form-control numeric">
                                    <i class="icon-screen-smartphone"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-left  m-t-20">
                        <div id="customer_submitbutton">
                            <!--<button type="submit" class="btn btn-embossed btn-primary">Create</button>-->
                            <a href="#" class="btn btn-embossed btn-primary" onClick="confirm()">Save</a>
                        </div>
    ...
    <div class="modal-dialog modal-lg" style="width:400px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Do you want to add a contact to associate with this account?
            </div>
            <div class="modal-footer">
                <button class="btn btn-primary btn-success btn-embossed bnt-square" onclick="addcontact()">Yes</button>
                <button class="btn btn-primary btn-danger btn-embossed bnt-square" onclick="submit()">No</button>
            </div>
        </div>
    </div>
</div>
