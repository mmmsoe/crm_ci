...
<script>
    $(document).ready(function () {
        $("form[name='change_profile']").submit(function (e) {
            ...
            $.ajax({
                url: "<?php echo base_url('admin/change_profile'); ?>",
                type: "POST",
                data: formData,
                async: false,
...

    {
        ...
        $.ajax({
            ...
            beforeSend: function (msg) {
                $("#submitbutton").html('<img src="<?php echo base_url('public/images/loading.gif'); ?>" />');
            },
            success: function (msg)
            {
                $('body,html').animate({scrollTop: 0}, 200);
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <input type="text" name="phone_number" value="<?php echo $user->phone_number; ?>" class="form-control numeric">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <input type="email" name="smtp_user" value="<?php echo $user->smtp_user; ?>" class="form-control">
                                                            <!--i class="icon-envelope"></i-->
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <input type="password" name="smtp_pass" value="<?php echo $user->smtp_pass; ?>" class="form-control">
                                                            <!--i class="icon-screen-smartphone"></i-->
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <input type="email" name="smtp_host" value="<?php echo $user->smtp_host; ?>" class="form-control">
                                                            <!--i class="icon-envelope"></i-->
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <input type="text" name="smtp_port" value="<?php echo $user->smtp_port; ?>" class="form-control numeric">
                                                            <!--i class="icon-screen-smartphone"></i-->
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <input type="text" name="imap_host" value="<?php echo $user->imap_host; ?>" class="form-control">
                                                            <!--i class="icon-screen-smartphone"></i-->
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="append-icon">
                                                            <input type="imap_port" name="imap_port" value="<?php echo $user->imap_port; ?>" class="form-control numeric">
                                                            <!--i class="icon-envelope"></i-->  
                                                        </div>
                                                    </div>
                                                </div>                                        
