...
<html>
...

 {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "<?php echo base_url('admin/login_process'); ?>",
        ...
        success: function(msg)
        {
            ...
            if(msg.substring(1,7) != 'script')
            {
                ...
                $("#submitbutton").html('<button type="submit" id="submit-form" class="btn btn-lg btn-dark btn-rounded ladda-button" data-style="expand-left" onClick="login_user()"><?php echo lang('sign_in_title'); ?></button>');
            }
            else
            { 
                $("#ajax").html(msg); 
...

 {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "<?php echo base_url('admin/lostpassword_process'); ?>",
    ...
    <body class="account2" data-page="login" style="background-image:url('<?php echo base_url('uploads/site').'/'.config('login_bg'); ?>');background-attachment: fixed;background-position: center;background-repeat: no-repeat;background-size: cover;">
       ...
       <div class="container" id="login-block">
           <div class="container" id="login-block" style="padding-top: 150px; padding-left: 120px">
               <div class="row" style="margin-left: 50px">
                    <div class="col-sm-10" style="color:white">
                        <!--<h4><b>Modular &amp; Flexible Admin. <?php echo 'ver '. APP_VER;?></b></h4>-->     
                    </div>
<!--                    <div class="col-sm-2">
                        <img src="<?php echo base_url('uploads/site').'/'.config('site_logo'); ?>" alt="company logo" class="" style="height: 30px;"></a> 
                    </div>                                       -->
                </div>
<!--            <i class="user-img"><a href="<?php echo base_url(); ?>" class="">
               <img src="<?php echo base_url('uploads/site').'/'.config('site_logo'); ?>" alt="company logo" class="" style="height: 30px;"></a> 
               <h4><b></b>Modular &amp; Flexible Admin. <?php echo 'ver '. APP_VER;?> </h4>     
            </i>            -->
<!--            <div class="account-info background_tes">
                ...
                <h3><?php echo 'ver '. APP_VER;?> </h3>
                </div>
-->         
            <div class="account-form background_tes" style="width: 400px; background-color:#0C5AAF; color:white; text-align:center">
                <form class="form-signin" id="loginform" role="form"> 
                    ...
                    <?php 
                       //if (APP_VER == $app_ver->ver)
                        //{
                    ?>
                    <div id="submitbutton"><button type="submit" id="submit-form" class="btn btn-lg btn-dark btn-rounded ladda-button" data-style="expand-left" onClick="login_user()"><?php echo lang('sign_in_title'); ?></button></div>
                    <?php
                       // }else{
                       //     echo "<font color='red'>Database and Program Version Mismatched.</font>";
                       // }
                    ?>

                    <div class="text-right">
                        <?php echo "Version "; ?>
                        <?php echo constant('APP_VER'); ?>
                    </div>
