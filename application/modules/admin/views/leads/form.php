    ...
    function getWhois()
    {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#company_name').tokenfield('createToken', data.reg_org);
            ...
            <div class="panel-content">
                ...
                <form id="add_leads" name="add_leads" class="form-validation" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                <div class="append-icon">
                                    <div class="append-icon">
                                        ...
                                        <input type="text" placeholder="user@domain.com" id="website_whois" name="website_whois" value="<?php echo $lead->website; ?>" class="form-control" disabled="disabled">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <button type="button" class="btn btn-info" onclick='getWhois()' disabled="disabled" style="background:#dddddd;">Use Engine</button>
                            </div>
                        </div>
                    </div>
