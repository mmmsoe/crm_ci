...
<!--h2 class="col-md-6"><strong>Leads</strong></h2--> 
        <div>
            <?php if (check_staff_permission('lead_write')) { ?> 
                ...
                <a  style="float:right;" href="<?php echo base_url('admin/leads/archive_leads'); ?>" class="btn btn-success btn-embossed">Leads Archived</a>
				
				<a href="<?php echo base_url('admin/leads/'); ?>" class="btn btn-black btn-embossed"> Manage Leads</a> 	
                                <a href="<?php echo base_url('admin/leads/upload'); ?>" class="btn btn-black btn-embossed"> Upload Leads</a> 	
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div style="padding-top:25px;">
                            <button id="export_to_exel" class="btn btn-success">Export To Exel</button>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#export_to_exel").click(function(){
            var type = $("#lead_status_id").val();
            var time = $("#filter_time").val();
            var archived =  '';
            window.location = "<?=base_url('admin/leads/exporta/');?>/"+time+"/"+type+"/"+archived;
        });
    });
