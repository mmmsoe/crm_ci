...
$filename = 'Report-'.str_replace(' ', '-', $title).'-'.date('YmdHis');
  ...
  <div class="main_detail">
    ...
    <div class="detail_view_item">      
      <table width="100%" cellspacing="0" cellpadding="0" border="">
        <tbody>
          <tr>
            <th style="width:200px;"><b>Potential Name</b></th>
...
$html .='<tr>
            ...
            <td>'.$this->staff_model->get_user_fullname($opportunity->salesperson_id).'</td>
            ...
            <td style="text-align:right">'.number_format($opportunity->amount,2,'.',',').'</td>
          </tr>';
  }
$html .=' </tbody>
      </table>
