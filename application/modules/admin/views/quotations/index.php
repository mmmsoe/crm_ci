    ...
    <div class="row">
        <div>
            <?php if (check_staff_permission('quotations_write')) { ?>
                ...
                <a  style="float:right;" href="<?php echo base_url('admin/quotations/archive_quotations'); ?>" class="btn btn-success btn-embossed">Quotations Archived</a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div style="padding-top:25px;">
                            <a href="<?=base_url()?>admin/quotations/export" id="export_to_exel" class="btn btn-success" target="blank">Export To Exel</a>
                        </div>
                    </div>
                </div>
                <div class="panel-content pagination2 table-responsive">

                    <table class="table table-hover filter-between_date">
                            ...
                            <?php if (!empty($quotations)) { ?>
                                ...
                                foreach ($quotations as $quotation) {
                                    ...
                                    <tr id="quotation_id_<?php echo $quotation->id; ?>">
                                        ...
                                        <td><a href="<?php echo base_url('admin/' . $view . '/view/' . $quotation->id); ?>"><?php echo $quotation->quotations_number . '-' . $quotation->id ?></a></td>
                                        <td><?php echo date('m/d/Y', $quotation->date); ?></td>
