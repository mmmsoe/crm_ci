                                ...
                                <div class="form-group" id="load_contacts">
                                    <select name="contact_id" id="contact_id" class="form-control" data-search="true">
                                        ...
                                        foreach ($contact_persons as $contact_person) {
                                            ?>
                                            <option value="<?php echo $contact_person->id; ?>" <?php if ($contact_person->id == $comp->main_contact_person) { ?> selected <?php } ?>><?php echo $contact_person->first_name . " " . $contact_person->last_name; ?></option>
                                        <?php } ?> 
                                    </select>
                                </div>
                            </div>
