...
$unixtime = $quotation->date;
$date_q = date("Y/m/d H:i:s", $unixtime);
...
<div class="main" style="margin-top:-90px !important">  
  <div class="main_detail">
    <div class="detail_head_titel" style="margin-top:-30px !important">Sales Quotation<br><span><b>Ref No : </b>CO-' . $quotation->quotations_number . '</span> </div>
...
foreach ($qo_products as $qo_product) {
    ...
    $html .='<tr>
            ...
            <td><b>'.$qo_product->product_name.'</b><br><pre style= "border: medium none; background: none; padding: 0px; margin: 0px;">'.$description.'</pre></td>
...
$company_name2 = $this->customers_model->get_company($quotation->customer_id)->name;
$mpdf->SetTitle($company_name2 . " - Quotation");
