...
<script src="<?php echo base_url(); ?>public/assets/global/dist/bootstrap-tokenfield.js"></script>
<script>
...
if ($check_controller_nm == "dashboard") {
    ...
    <?php } ?>
        ...
        function stockCharts2(tabName, id) {
            var items = Array('',<?php foreach ($salesteams_performance_list as $team_performnce) {
