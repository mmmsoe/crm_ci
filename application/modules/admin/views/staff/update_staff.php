...
<div class="page-content page-thin">
    <div class="header">
        <h2><strong>Update Staff</strong></h2>            
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-content">
                    ...
                    <form id="update_user" name="update_user" class="form-validation" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="append-icon">
                                        <input type="text" name="phone_number" value="<?php echo $staff->phone_number; ?>" class="form-control numeric">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="append-icon">
                                        <input type="email" name="smtp_user" value="<?php echo $staff->smtp_user; ?>" class="form-control">
                                        <!--i class="icon-envelope"></i-->
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="append-icon">
                                        <input type="password" name="smtp_pass" value="<?php echo $staff->smtp_pass; ?>" class="form-control">
                                        <!--i class="icon-screen-smartphone"></i-->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="append-icon">
                                        <input type="text" name="smtp_host" value="<?php echo $staff->smtp_host; ?>" class="form-control">
                                        <!--i class="icon-screen-smartphone"></i-->
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="append-icon">
                                        <input type="smtp_port" name="smtp_port" value="<?php echo $staff->smtp_port; ?>" class="form-control numeric">
                                        <!--i class="icon-envelope"></i-->  
                                    </div>
                                </div>
                            </div>                                        
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="append-icon">
                                        <input type="text" name="imap_host" value="<?php echo $staff->imap_host; ?>" class="form-control">
                                        <!--i class="icon-screen-smartphone"></i-->
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="append-icon">
                                        <input type="imap_port" name="imap_port" value="<?php echo $staff->imap_port; ?>" class="form-control numeric">
                                        <!--i class="icon-envelope"></i-->  
                                    </div>
                                </div>
                            </div>                                        
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="append-icon">
                                        <input type="checkbox" name="banned" <?php
                                        if ($staff->status == 0) {
                                            echo 'checked="checked"';
                                        }
                                        ?> value="1" data-checkbox="icheckbox_square-blue"/> <?php echo $this->lang->line('yes'); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
										<!--
                                        <select name="role_id" id='role_id' class="form-control" style="margin-top: 3px;">
                                            <?php if (!empty($role)) { ?>
                                                <?php foreach ($role as $r) { ?> 
                                                    <option value="<?php echo $r->role_id; ?>" <?php if($staff->role_id == $r->role_id){ ?> selected <?php }?>><?php echo $r->role_name; ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
										-->
										<input type="hidden" value="<?php echo $staff->role_id; ?>" name="role_id_" id="role_id_" />
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">Support Access Level</label>
                                    <div class="form-group">
                                        <select name="support_access_level" id='support_access_level' class="form-control" style="margin-top: 3px;">
                                            <option value=""></option>
                                            <?php foreach($support_access as $l):?>
                                                <option value="<?php echo $l->system_value_num?>" <?php if($staff->support_access_level == $l->system_value_num){ ?> selected <?php }?>><?php echo $l->system_value_txt?></option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <!--
                                                <div class="row">
                                                    ...
                                                    <div class="panel-content">
                                                        ...
                                                        <h3><label><input type="checkbox" id="permission_check" name="permission_check" value="1" data-checkbox="icheckbox_square-blue"><strong>permissions</strong></label></h3>  
                                                        <div class="row">	
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="sales_team" id="sales_team" value="1" data-checkbox="icheckbox_square-blue"><strong>Sales Teams</strong></label></p>	
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check sales_team" name="sales_team_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'sales_team_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check sales_team" name="sales_team_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'sales_team_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check sales_team" name="sales_team_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'sales_team_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>		
                                                                                                </div>
                        
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="leads" id="leads" value="1" data-checkbox="icheckbox_square-blue"><strong>Leads</strong></label></p>
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check leads" name="lead_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'lead_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check leads" name="lead_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'lead_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check leads" name="lead_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'lead_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>		
                                                                                                </div>
                        
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="opportunities" id="opportunities" value="1" data-checkbox="icheckbox_square-blue"><strong>Opportunities</strong></label></p>	
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check opportunities" name="opportunities_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'opportunities_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check opportunities" name="opportunities_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'opportunities_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check opportunities" name="opportunities_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'opportunities_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>	
                                                                                                </div>
                        
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="logged_calls" id="logged_calls" value="1" data-checkbox="icheckbox_square-blue"><strong>Logged Calls</strong></label></p>				
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check logged_calls" name="logged_calls_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'logged_calls_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check logged_calls" name="logged_calls_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'logged_calls_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check logged_calls" name="logged_calls_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'logged_calls_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>	
                                                                                                </div>
                        
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="meetings" id="meetings" value="1" data-checkbox="icheckbox_square-blue"><strong>Meetings</strong></label></p>	
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check meetings" name="meetings_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'meetings_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check meetings" name="meetings_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'meetings_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check meetings" name="meetings_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'meetings_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>	
                                                                                                </div>
                        
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="products" id="products" value="1" data-checkbox="icheckbox_square-blue"><strong>Products</strong></label></p>		
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check products" name="products_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'products_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check products" name="products_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'products_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check products" name="products_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'products_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>	
                                                                                                </div>
                                                        ...
                                                        <div class="row">		
                                                                                                ...
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="quotations" id="quotations" value="1" data-checkbox="icheckbox_square-blue"><strong>Quotations</strong></label></p>	
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check quotations" name="quotations_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'quotations_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check quotations" name="quotations_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'quotations_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check quotations" name="quotations_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'quotations_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>		
                                                                                                </div>
                        
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="sales_orders" id="sales_orders" value="1" data-checkbox="icheckbox_square-blue"><strong>Sales Orders</strong></label></p>	
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check sales_orders" name="sales_orders_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'sales_orders_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check sales_orders" name="sales_orders_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'sales_orders_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check sales_orders" name="sales_orders_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'sales_orders_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>		
                                                                                                </div>
                        
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="invoices" id="invoices" value="1" data-checkbox="icheckbox_square-blue"><strong>Invoices</strong></label></p>
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check invoices" name="invoices_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'invoices_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check invoices" name="invoices_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'invoices_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check invoices" name="invoices_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'invoices_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>		
                                                                                                </div>
                        
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="tickets" id="tickets" value="1" data-checkbox="icheckbox_square-blue"><strong>Tickets</strong></label></p>
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check tickets" name="tickets_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'tickets_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check tickets" name="tickets_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'tikets_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check tickets" name="tickets_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'tikets_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>		
                                                                                                </div>
                        
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="knowledge_base" id="knowledge_base" value="1" data-checkbox="icheckbox_square-blue"><strong>Knowledge Base</strong></label></p>	
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check knowledge_base" name="knowledge_base_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'knowledge_base_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check knowledge_base" name="knowledge_base_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'knowledge_base_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check knowledge_base" name="knowledge_base_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'knowledge_base_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>		
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="col-md-2">
                                                                                                    <p><label><input type="checkbox" class="permission_check" name="staff" id="staff" value="1" data-checkbox="icheckbox_square-blue"><strong>Staff</strong></label></p>	
                                                                                                    <div class="input-group">
                                                                                                        <div class="icheck-list" style="padding-left:10px;">
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check staff" name="staff_read" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'staff_read')) echo 'checked'; ?>>Read</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check staff" name="staff_write" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'staff_write')) echo 'checked'; ?>>Write</label>
                                                                                                            <label>
                                                                                                                <input type="checkbox" class="permission_check staff" name="staff_delete" value="1" data-checkbox="icheckbox_square-blue" <?php if (get_permission_value($staff->id, 'staff_delete')) echo 'checked'; ?>>Delete</label>
                                                                                                        </div>
                                                                                                    </div>		
                                                                                                </div>
                        ...
                        <div class="text-left  m-t-20">
                            <div id="staff_submitbutton"><button type="submit" class="btn btn-embossed btn-primary">Update</button></div>
...
<script>
    ...
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (status == "yes")
                    {
                        ...
                        $("#staff_ajax").html('<?php echo '<div class="alert alert-success">' . $this->lang->line('update_succesful') . '</div>' ?>');
                        setTimeout(function () {
		...
		// edit by nanin mulyani 20160831 1445
...
<?php if (get_permission_value($staff->id, 'sales_team_read') && get_permission_value($staff->id, 'sales_team_write') && get_permission_value($staff->id, 'sales_team_delete')) { ?>
            $('#sales_team').iCheck('check');
            c1 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'lead_read') && get_permission_value($staff->id, 'lead_write') && get_permission_value($staff->id, 'lead_delete')) { ?> //leads
            $('#leads').iCheck('check');
            c2 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'opportunities_read') && get_permission_value($staff->id, 'opportunities_write') && get_permission_value($staff->id, 'opportunities_delete')) { ?> //opportunities
            $('#opportunities').iCheck('check');
            c3 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'logged_calls_read') && get_permission_value($staff->id, 'logged_calls_write') && get_permission_value($staff->id, 'logged_calls_delete')) { ?> // logged calls
            $('#logged_calls').iCheck('check');
            c4 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'meetings_read') && get_permission_value($staff->id, 'meetings_write') && get_permission_value($staff->id, 'meetings_delete')) { ?>//meetings
            $('#meetings').iCheck('check');
            c5 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'products_read') && get_permission_value($staff->id, 'products_write') && get_permission_value($staff->id, 'products_delete')) { ?>//products
            $('#products').iCheck('check');
            c6 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'quotations_read') && get_permission_value($staff->id, 'quotations_write') && get_permission_value($staff->id, 'quotations_delete')) { ?>//quotations
            $('#quotations').iCheck('check');
            c7 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'sales_orders_read') && get_permission_value($staff->id, 'sales_orders_write') && get_permission_value($staff->id, 'sales_orders_delete')) { ?>//sales_orders
            $('#sales_orders').iCheck('check');
            c8 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'invoices_read') && get_permission_value($staff->id, 'invoices_write') && get_permission_value($staff->id, 'invoices_delete')) { ?>//invoices
            $('#invoices').iCheck('check');
            c9 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'tickets_read') && get_permission_value($staff->id, 'tickets_write') && get_permission_value($staff->id, 'tickets_delete')) { ?>//tickets
            $('#tickets').iCheck('check');
            c10 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'knowledge_base_read') && get_permission_value($staff->id, 'knowledge_base_write') && get_permission_value($staff->id, 'knowledge_base_delete')) { ?>
            $('#knowledge_base').iCheck('check');
            c11 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'staff_read') && get_permission_value($staff->id, 'staff_write') && get_permission_value($staff->id, 'staff_delete')) { ?>
            $('#staff').iCheck('check');
            c12 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'payment_log_read') && get_permission_value($staff->id, 'payment_log_write') && get_permission_value($staff->id, 'payment_log_delete')) { ?>
            $('#payment_log').iCheck('check');
            c13 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'analytics_read') && get_permission_value($staff->id, 'analytics_write') && get_permission_value($staff->id, 'analytics_delete')) { ?>
            $('#analytics').iCheck('check');
            c14 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'email_read') && get_permission_value($staff->id, 'email_write') && get_permission_value($staff->id, 'email_delete')) { ?>
            $('#email_auth').iCheck('check');
            c15 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'activity_entry_read') && get_permission_value($staff->id, 'activity_entry_write') && get_permission_value($staff->id, 'activity_entry_delete')) { ?>
            $('#activity_entry').iCheck('check');
            c16 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'calendar_read') && get_permission_value($staff->id, 'calendar_write') && get_permission_value($staff->id, 'calendar_delete')) { ?>
            $('#calendar').iCheck('check');
            c17 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'account_read') && get_permission_value($staff->id, 'account_write') && get_permission_value($staff->id, 'account_delete')) { ?>
            $('#account').iCheck('check');
            c18 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'contacts_read') && get_permission_value($staff->id, 'contacts_write') && get_permission_value($staff->id, 'contacts_delete')) { ?>
            $('#contacts').iCheck('check');
            c19 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'campaign_listing_read') && get_permission_value($staff->id, 'campaign_listing_write') && get_permission_value($staff->id, 'campaign_listing_delete')) { ?>
            $('#campaign_listing').iCheck('check');
            c20 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'update_application_read') && get_permission_value($staff->id, 'update_application_write') && get_permission_value($staff->id, 'update_application_delete')) { ?>
            $('#update_application').iCheck('check');
            c21 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'people_listing_read') && get_permission_value($staff->id, 'people_listing_write') && get_permission_value($staff->id, 'people_listing_delete')) { ?>
            $('#people_listing').iCheck('check');
            c22 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'product_setting_read') && get_permission_value($staff->id, 'product_setting_write') && get_permission_value($staff->id, 'product_setting_delete')) { ?>
            $('#product_setting').iCheck('check');
            c23 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'system_setting_read') && get_permission_value($staff->id, 'system_setting_write') && get_permission_value($staff->id, 'system_setting_delete')) { ?>
            $('#system_setting').iCheck('check');
            c24 = 1;
<?php } ?>
<?php if (get_permission_value($staff->id, 'master_system_read') && get_permission_value($staff->id, 'master_system_write') && get_permission_value($staff->id, 'master_system_delete')) { ?>
            $('#master_system').iCheck('check');
            c25 = 1;
<?php } ?>
        if (c2 == 1 && c3 == 1 && c7 == 1 && c8 == 1 && c9 == 1 && c13 == 1 && c14 == 1 && c1 == 1 && c15 == 1 && c3 == 1 && c17 == 1 && c4 == 1 && c5 == 1 && c18 == 1 && c19 == 1 && c10 == 1 && c11 == 1 && c20 == 1 && c22 == 1 && c23 == 1 && c24 == 1 && c6 == 1 && c12 == 1)
        {
            $('#permission_check').iCheck('check');
        }

        if (c2 == 1 && c3 == 1 && c7 == 1 && c8 == 1 && c9 == 1 && c13 == 1 && c14 == 1 && c1 == 1)
        {
            $('#sales').iCheck('check');
        }

        if (c15 == 1 && c3 == 1 && c17 == 1 && c4 == 1 && c5 == 1)
        {
            $('#activities').iCheck('check');
        }
        ...
        if ( c22 == 1 && c23 == 1 && c24 == 1 && c6 == 1 && c12 == 1)
        {
            console.log('oioi');
            $('#setting').iCheck('check');
        }
