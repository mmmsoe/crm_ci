...
$(document).ready(function() {
	...
	$("#print").attr('href', '<?php echo base_url('admin/report/print_sales_duration_lead_source').'/'; ?>');
			
	$("#applyFilter").click(function() {
		var min = document.getElementById("min").value;
		var max = document.getElementById("max").value;
		var stat = 'sales_duration_lead_source';
		...
		$.ajax({
			...
			success: function(data){
				...
				$("#tbSalesDurationls").html(data);
				$('#loader').slideUp(200, function() {
					$(this).remove();
				});
				$("#print").attr('href', '<?php echo base_url('admin/report/print_sales_duration_lead_source').'/'; ?>'+ print);
			},
		});
	});
});
...
.table-hover > tbody > tr.nohov:hover > td {
            ...
            <div class="row">
			   ...
			   <div class="panel-content">
				...
				<div class="col-sm-3">
                  ...
                  <table class="table table-hover filter-between_date" id="tbSalesDurationls">
 ...
 <?php
	...
	echo "<th>" . $list[0]->lead_sources . "</th>";
    ...
    for ($i = 1; $i < count($list); $i++) {
        ...
        echo "<tbody>";
        echo "<tr>";
        echo "<td>".$list[$i]->lead_sources . "</td>";		
	...
	if($list[0]->lead_sources){
		...
		$ind_name = explode("~", $list[0]->regis_datetime); //$list[0] adalah index header
		for ($i = 0; $i < count($ind_name); $i++) {
			echo "<td class='numeric'>" . $this->report_model->get_avg_sales_duration_lead_source_by_month($ind_name[$i]) . "</td>";
		}
		echo "<td class='numeric'>" . $this->report_model->get_avg_sales_duration_lead_source_by_month() . "</td>";
		echo "</tr>";
	}
		echo "</tbody>";
    ?>
