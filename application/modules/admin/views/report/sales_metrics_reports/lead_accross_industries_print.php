...
$ind_name = explode("~", $list[0]->industries);
for ($i = 0; $i < count($ind_name); $i++) {		
$html .="<td style='text-align:right;'>" . $this->report_model->get_avg_conversion_accross_industries($ind_name[$i],$min,$max) . "</td>

		";
	}
$html .="<td style='text-align:right;'>" . $this->report_model->get_avg_conversion_accross_industries('',$min,$max) . "</td>";
