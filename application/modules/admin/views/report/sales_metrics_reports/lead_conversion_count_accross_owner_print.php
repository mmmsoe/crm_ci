...
$html .="<th>Sum of Record Count</th>";
$html .="</tr>";
...
$html .="<td>Sum of Record Count</td>";
		$ind_name = explode("~", $list[0]->regis_datetime);
		for ($i = 0; $i < count($ind_name); $i++) {
$html .="<td class='numeric'>". $this->report_model->get_avg_conversion_count_accross_owner($ind_name[$i],$min,$max) ."</td>";
		}
$html .="<td class='numeric'>"  . $this->report_model->get_avg_conversion_count_accross_owner('',$min,$max) ."</td>";
$html .="</tr>";
