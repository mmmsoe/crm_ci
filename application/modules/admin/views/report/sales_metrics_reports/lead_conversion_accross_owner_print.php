...
$html .="<th>Avg of Lead Conversion Time in Day(s)</th>";
$html .="</tr>";
...
$html .="<td>>Avg of Lead Conversion Time in Day(s)</td>";
		$ind_name = explode("~", $list[0]->regis_datetime);
		for ($i = 0; $i < count($ind_name); $i++) {
$html .="<td class='numeric'>" . $this->report_model->get_avg_conversion_accross_owner($ind_name[$i],$min,$max) ."</td>";
		}
$html .="<td class='numeric'>" . $this->report_model->get_avg_conversion_accross_owner('',$min,$max)."</td>";
$html .="</tr>";
