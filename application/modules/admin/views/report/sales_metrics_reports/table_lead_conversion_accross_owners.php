<?php
	...
	$ind_name = explode("~", $list[0]->regis_datetime);
	for ($i = 0; $i < count($ind_name); $i++) {
	echo "<td class='numeric'>" . $this->report_model->get_avg_conversion_accross_owner($ind_name[$i],$min,$max) . "</td>";
	}
	echo "<td class='numeric'>" . $this->report_model->get_avg_conversion_accross_owner('',$min,$max) . "</td>";
	echo "</tr>";
