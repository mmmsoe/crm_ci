...
$html .='
		  <tr>
			...
			<td colspan="5" style="background:#f0f4f8">'.$this->customers_model->get_account_name($opportunity_group->customer_id,'name') .' ('.$opportunity_group->cnt.')'.'</td>
	                    
			</tr>';
			  
$opportunities = $this->opportunities_model->get_list_by_group( array('customer_id' => $opportunity_group->customer_id), $min, $max, 'customer' );
