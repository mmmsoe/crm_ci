      ...
      <table width="100%" cellspacing="0" cellpadding="0" border="">
        <tbody>
          <tr>
            ...
            <th><b>Contact Created Time</b></th>
            <th><b>Mailing Street</b></th>
            <th><b>Mailing City</b></th>
            <th><b>Mailing State</b></th>
            <th><b>Mailing Country</b></th>
            <th><b>Mailing Zip</b></th>
         	</tr>';
if( ! empty($contacts) ){
...
$html .='<tr>
			...
			<td>'.$this->customers_model->get_account_name($contacts->company_id,'name').'</td>
	        
				<td>'.date('Y-m-d',$contacts->register_time).'</td>
				<td>'.$contacts->address.'</td>
				<td>'.$this->customers_model->get_cities_name($contacts->city_id,'name','city').'</td>
	         	<td>'.$this->customers_model->get_cities_name($contacts->state_id,'name','state').'</td>
	         			    
				    <td>'.$this->customers_model->get_cities_name($contacts->country_id,'name','country').'</td>
