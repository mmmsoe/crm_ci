  ...
  <div class="main_detail">
    ...
    <div class="detail_view_item">      
      <table width="100%" cellspacing="0" cellpadding="0" border="1">
        <tbody>
          <tr>
            <th style="width:100px;"><b>Quotations Number</b></th>
            <th><b>Date</b></th>
            <th><b>Customer</b></th>
            <th><b>Sales Person</b></td>
            <th><b>Total</b></th>
            <th><b>Status</b></th>
          </tr>';
foreach( $report as $report){          
$html .='<tr>
            <td>'.$report->quotations_number.'</td>
            <td>'.date('m/d/Y',$report->date).'</td>
            <td>'.$this->customers_model->get_account_name($report->customer_id,'name').'</td>
			<td>'.$this->staff_model->get_user_fullname($report->sales_person).'</td>
            <td style="text-align:right">'.number_format($report->grand_total,2,'.',',').'</td>
            <td>'.$report->status.'</td>
          </tr>';
  }
$html .=' </tbody>
