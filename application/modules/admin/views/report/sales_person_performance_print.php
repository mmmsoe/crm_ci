...
$html .='
			  <tr>
				<td colspan="5" style="background:#f0f4f8">'. $this->staff_model->get_user_fullname($opportunity_group->salesperson_id).' ('.$opportunity_group->cnt.')' .'</td>
			  </tr>';
			  
$opportunities = $this->opportunities_model->get_list_by_group( array('salesperson_id' => $opportunity_group->salesperson_id), $min, $max,'leads');
...
$html .='
			  <tr>			  
				...
				<td class="numeric">'. number_format($this->leads_model->get_lead_single( $opportunity->lead_id )->annual_revenue, 2, '.', ',') .'</td>
...
$html .='
			  <tr>
				<td colspan="5" style="border-top: 3px solid #ddd;" class="numeric">'. number_format($opportunity_group->amt, 2, '.', ',') .'</td>
			  </tr>';
	}
}
$html .='
			  <tr>
				<td colspan="5" style="background:#ddd;" class="numeric">'. number_format($sum_amount, 2, '.', ',') .'</td>
			  </tr>';
