...
$html .='
			  <tr>
			   ...
			   <td>'.$leads->email.'</td>
			   <td>'.$leads->phone.'</td>
			   <td>'.$this->system_model->system_single_value('LEAD', $leads->lead_source_id)->system_value_txt.'</td>
			   <td>'.$this->system_model->system_single_value('LEAD_STATUS', $leads->lead_status_id)->system_value_txt.'</td>
