...
$html .='
			  <tr>
				<td colspan="7" style="background:#f0f4f8">'. $this->system_model->system_single_value('INDUSTRY', $lead_group->industry_id)->system_value_txt .' ('.$lead_group->cnt.')' .'</td>
			  </tr>';
			  
$leads = $this->leads_model->get_list_by_group_account( array('a.industry_id' => $lead_group->industry_id),$min,$max,'');
			if( ! empty($leads) ){
...
$html .='
			  <tr>			  
				...
				<td>'. date('Y/m/d G:i A', $lead->register_time) .'</td>
			  </tr>';
				}
			}
