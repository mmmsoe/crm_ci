    ...
    <div class="row">
        <div>
            <?php if (check_staff_permission('sales_orders_write')) { ?>
                ...
                <a  style="float:right;" href="<?php echo base_url('admin/salesorder/archive_salesorder'); ?>" class="btn btn-success btn-embossed">Sales Order Archived</a>
                <a href="<?php echo base_url('admin/salesorder/'); ?>" class="btn btn-black btn-embossed"> Manage Sales Order</a> 	
                <a href="<?php echo base_url('admin/salesorder/templates'); ?>" class="btn btn-gray btn-embossed"> Sales Order Templates</a> 	
            <?php } ?>
        </div>           
    </div>
