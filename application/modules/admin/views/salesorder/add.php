										...
										<div class="row">
					                    	<div class="col-sm-6">
												<div class="form-group">
													...
													<div class="form-group">
														<div class="form-group col-xs-8 clearPad-lr clearRad-r-box">
															<select name="sales_person" id="sales_person" class="form-control full clearRad-r" data-search="true">
																<option value="" selected="selected">Choose Sales</option>
																<?php foreach( $staffs as $staff){ ?>
																	<option value="<?php echo $staff->id;?>" <?php if($quotation->sales_person==$staff->id){?> selected="selected"<?php }?>><?php echo $staff->first_name.' '.$staff->last_name;?></option>
																<?php }?> 
															</select>
														</div>
														<div class="form-group col-xs-4 clearPad-lr bord-l  clearRad-l-box">
															<select name="sales_team_id" id="sales_team_id" class="form-control full" data-search="true">
					                    ...
					                    <div class="row">
					                    	 ...
					                    	 <div class="panel-content">
                									 ...
                									 <table class="table">
									                  ...
									                  <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-create_product">Add a product</a>
                 									 </div>
