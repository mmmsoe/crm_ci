...
<script>
    ...
    $(document).ready(function () {
        ...
        $("form[name='update_quotation']").submit(function (e) {
            ...
            var formData = new FormData($(this)[0]);
            $.ajax({
                url: "<?php echo base_url('admin/salesorder/update_process'); ?>",
                type: "POST",
                data: formData,
                async: false,
                success: function (msg) {
                    ...
                    if (status == "yes")
                    {
                        ...
                        setTimeout(function () {
                            window.location.href = "<?php echo base_url('admin/salesorder/view'); ?>/" + id;
...
//Delete products
    ...
    function delete_qo_product(product_id)
    {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('admin/salesorder/delete_qo_product'); ?>/" + product_id,
            success: function (msg)
            {
                if (msg != '')
                {
...
//Get quotation templates products
    function getQtemplatesProducts(id)
    {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url('admin/salesorder/ajax_qtemplates_products') . '/'; ?>' + id + '/' + pricelist_id,
            // data: id='qt_id',
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url('admin/salesorder/ajax_get_quotation_template_duration') . '/'; ?>' + id,
...
//Get quotation templates products
    function getPricelistProducts(id)
    {
        ...
        if (qtemplate_id != "")
        {
            $.ajax({
                type: "POST",
                url: '<?php echo base_url('admin/salesorder/ajax_qtemplates_products') . '/'; ?>' + qtemplate_id + '/' + id,
                data: id = 'qt_id',
                success: function (data) {
                    //alert(data);
                    $("#InputsWrapper").html(data);
    ...
    function getProducts_Price(id)
    {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url('admin/salesorder/ajax_get_products_price') . '/'; ?>' + id + '/' + pricelist_id,
            async: false,
            data: id = 'p_id',
            success: function (data) {
                result = data;
...
//get contact details in company
    function getcontactdetails(id)
    {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url('admin/salesorder/ajax_contact_list') . '/'; ?>' + id,
            // data: id='cat_id',
            success: function (data) {
...
<div class="page-content">
    <div class="row">
        <h2 class="col-md-6"><strong>Sales Order <?php echo $quotation->salesorder_number; ?></strong></h2>
        ...
        <div class="panel">
            ...
            <div class="panel-content">
                ...
                <form id="update_quotation" name="update_quotation" class="form-validation" accept-charset="utf-8" enctype="multipart/form-data" method="post"> 
                    <input  type="hidden" name="quotation_id" value="<?php echo $quotation->quotations_id; ?>"/> 
                    <input  type="hidden" name="salesorder_id" value="<?php echo $quotation->id; ?>"/> 
                    <div class="row">
                        <div class="col-sm-6">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="send_quotation" name="send_quotation" class="form-validation" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="quotation_id" id="quotation_id" value="<?php echo $quotation->quotations_id; ?>" class="form-control">    
                    <input type="hidden" name="salesorder_id" id="quotation_id" value="<?php echo $quotation->id; ?>" class="form-control">    
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="field-1" class="control-label">Subject</label> 
                                <input type="text" name="email_subject" id="email_subject" value="Demo Company Order (Ref <?php echo $quotation->salesorder_number; ?>)" class="form-control"> 
...
<?php } ?> 
    ...
    <p style="border-left: 1px solid #8e0000; margin-left: 30px;">
       ...
       &nbsp;&nbsp;Order number: <strong><?php echo $quotation->salesorder_number; ?></strong><br>
