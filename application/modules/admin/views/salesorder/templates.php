<script>
    ...
    function get_templates()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/salesorder/get_templates'); ?>",
            dataType: "json",
    ...
    function delete_template() {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/salesorder/delete_template'); ?>",
            dataType: "json",
            data: {
    ...
    function use_template()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/salesorder/use_template'); ?>",
            dataType: "json",
            data: {
                template_id: $('#template_id').val()
            },
    ...
    function submitForm() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>admin/salesorder/do_upload",
            type: "POST",
            data: fd,
            processData: false,
            contentType: false
...
<div class="page-content">
     <div class="row">
        <div>
            <?php if (check_staff_permission('salesorder_write')) { ?>
                <a style="float:right;" href="<?php echo base_url('admin/salesorder/add/'); ?>" class="btn btn-primary btn-embossed"> Create New</a> 
                <a href="<?php echo base_url('admin/salesorder/'); ?>" class="btn btn-gray btn-embossed"> Manage Sales Order</a> 	
                <a href="<?php echo base_url('admin/salesorder/templates'); ?>" class="btn btn-black btn-embossed"> Sales Order Templates</a> 	
            <?php } ?>	
        </div>           
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="panel">
            ...
            <div class="panel-body" style="text-transform: uppercase;">
                ...
                <a href="<?php echo base_url() ?>uploads/words/template/sales_order_template.docx" >
