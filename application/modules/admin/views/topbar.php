    ...
    <div class="header-left">
        <div class="topnav">
            ...
            <ul class="nav nav-horizontal">
                                <!--li><a href="#<?php //echo base_url('admin/dashboard');    ?>"><?php echo config('site_name'); ?></a></li-->
            <?php if (check_staff_permission('email_read')){?><li class="<?php echo is_active_menu('mailbox'); ?>"><a href="<?php echo base_url('admin/mailbox'); ?>"><!--<span class="pull-right badge badge-primary">8</span>--><i class="fa fa-envelope"></i><span>Email</span></a></li><?php } ?>
                <?php /* <li class="<?php echo is_active_menu('mailbox'); ?>"><a href="<?php echo base_url('admin/mailbox'); ?>"><!--<span class="pull-right badge badge-primary">8</span>--><i class="fa fa-envelope"></i><span>Email</span></a></li>

                  <?php if (check_staff_permission('sales_orders_read')){?>
                  <li class="<?php echo is_active_menu('salesorder'); ?>"><a href="<?php echo base_url('admin/salesorder'); ?>"><i class="fa fa-shopping-cart"></i><span>Sales Orders</span></a></li>
                  <?php }?>

                  <?php if (check_staff_permission('invoices_read')){?>
                  <li class="<?php echo is_active_menu('invoices'); ?>"><a href="<?php echo base_url('admin/invoices'); ?>"><i class="icon-note"></i><span>Invoices</span></a></li>
                  <?php }?> ?>
            ...
            <li class="dropdown" id="user-header">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <?php if (userdata('user_avatar')) { ?>
                        <img src="<?php echo base_url(); ?>uploads/staffs/<?php echo userdata('user_avatar'); ?>" alt="" style="height: 36px;width: 36px;">
                    <?php } else { ?>

                        <img src="<?php echo base_url(); ?>public/assets/global/images/avatars/user1.png" alt="" style="height: 36px;width: 36px;">                
                    <?php } ?>	
